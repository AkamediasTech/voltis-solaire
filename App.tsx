      ...
      <main className="flex-grow">
        ...
        <section className="bg-edf-blue py-12 px-4">
           <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-12 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">Prêt à passer au solaire ?</h2>
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                 Rejoignez les 50 000 foyers qui font confiance à EDF Solutions Solaires pour leur transition énergétique.
              </p>
              <button 
