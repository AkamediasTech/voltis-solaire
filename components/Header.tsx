        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-edf-blue font-bold text-xl leading-none tracking-tight">
                SOLUTIONS
              </span>
          ...
          <div className="flex items-center">
            <button
              onClick={scrollToTop}
              className="cursor-pointer  bg-edf-blue text-white px-4 md:px-6 py-2.5 rounded-full text-[11px] md:text-sm font-bold hover:bg-edf-lightBlue transition-all shadow-md transform active:scale-95 whitespace-nowrap"
            >
              <span className="md:hidden">Bilan Solaire Gratuit</span>
              <span className="hidden md:inline">
                Obtenir mon Bilan Solaire Gratuit
              </span>
            </button>
          </div>
        </div>
