          ...
          <div className="p-8 md:p-16 lg:w-2/3 flex flex-col justify-center">
            <h2 className="text-2xl md:text-3xl font-normal text-gray-800 mb-6">
              ...
              <span className="font-medium">
                intelligent de votre consommation
              </span>
            </h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              avec des panneaux photovoltaïques performants et garantis à vie
              <sup>(5)</sup>. Notre "garantie matériel" à vie<sup>(5)</sup>,
              pièces, main d'œuvre et déplacement porte sur les équipements
              suivants :
            </p>
            <ul className="space-y-2 mb-8">
              <li className="flex items-center gap-2 font-bold text-edf-orange">
                <span className="w-1.5 h-1.5 rounded-full bg-edf-orange"></span>{" "}
                l'onduleur
              </li>
              <li className="flex items-center gap-2 font-bold text-edf-orange">
                <span className="w-1.5 h-1.5 rounded-full bg-edf-orange"></span>{" "}
            ...
            <p className="text-gray-600 leading-relaxed text-sm">
              Investissez dans une solution durable et fiable vous permettant de
              réaliser des économies d'énergie<sup>(3)</sup> tout au long de
              votre vie<sup>(5)</sup>.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
          ...
          <div className="bg-gray-100 p-8 md:p-16 flex flex-col justify-center lg:col-span-2">
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              <span className="font-bold text-gray-800">
                Yuze est un compagnon intelligent
              </span>{" "}
              pour votre installation solaire. Il remonte{" "}
              <span className="font-bold text-gray-800">
                sur votre Espace Client EDF solutions solaires
              </span>{" "}
              :
            </p>
            <ul className="space-y-2 mb-6 text-gray-600 list-disc pl-5">
              ...
              <li>
                La production d'électricité de l'installation photovoltaïque.
              </li>
              <li>Et donc, calcule votre surplus de production solaire.</li>
            </ul>
            <p className="text-edf-orange font-bold leading-relaxed">
              Et pour aller plus loin, profitez de notre Afficheur pour
              visualiser en temps réel et en un simple coup d'œil votre
          ...
          <div className="bg-gray-100 p-8 md:p-16 flex flex-col justify-center order-2 lg:order-1 lg:col-span-2">
            <div className="hidden lg:block mb-8">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-edf-blue rounded-full flex items-center justify-center text-white font-bold text-sm">
                  e
                </div>
                <div className="flex flex-col">
                  <span className="text-edf-blue font-bold text-sm leading-none">
                    SOLUTIONS
                  </span>
            ...
            <p className="text-gray-800 text-lg mb-6 leading-relaxed">
              Suivez et pilotez en temps réel votre consommation directement
              depuis votre téléphone grâce à l'application mobile Groupe France
              Solaire.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Profitez de conseils personnalisés avec un conseiller pour
              optimiser votre consommation au mieux.
            </p>
          </div>
