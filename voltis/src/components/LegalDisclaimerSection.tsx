...
export const LegalDisclaimerSection: React.FC = () => {
  const disclaimers = [
    ...
    "(5) La garantie à vie comprend l’onduleur, les modules photovoltaïques, la structure, ainsi que la main d’œuvre et les déplacements associés. Sous réserve du respect des conditions de mise en œuvre des garanties, selon Conditions Générales de Vente applicables.",
  ];
