          ...
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
              <button
                ...
                className="cursor-pointer bg-edf-orange text-white font-bold py-3.5 px-8 rounded-full hover:bg-edf-orangeHover transition-colors shadow-lg shadow-orange-100"
              >
