      ...
      {!isSuccess && (
        <>
          <div className="mb-8 ">
            ...
            <div>
              <div
                className={`relative overflow-hidden pt-3 flex items-center gap-1 justify-center`}
              >
                <div className="absolute inset-0 -translate-x-full animate-shimmer bg-gradient-to-r from-transparent via-white/30 to-transparent" />
                {/* <Zap className="w-5 h-5 mx-2 text-edf-orange fill-current relative z-10" /> */}
                <p className="relative text-black font-bold text-center text-lg md:text-lg lg:text-2xl tracking-wide drop-shadow-lg z-10">
                  Calculez votre prime en 3 clics
                </p>
              </div>
              <p className="relative text-edf-orange font-semibold text-center text-[12px] lg:text-sm tracking-wide drop-shadow-lg z-10">
