      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-5xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
            Passez au solaire et réalisez jusqu'à 70%<sup>(1)</sup> d'économies
            d'énergie à l'année
          </h2>
        </div>
        ...
        <div className="border border-gray-200 rounded-sm p-8 md:p-12 bg-white">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-4">
            ...
            <div className="flex-1 flex flex-col items-center text-center px-2">
              ...
              <h3 className="text-xl font-bold text-edf-orange mb-3">
                Une étude gratuite
              </h3>
              <p className="text-gray-800 text-sm leading-relaxed">
                pour une installation sur-mesure par notre Conseiller Solaire à
                votre domicile
              </p>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center text-center px-2">
              ...
              <p className="text-gray-800 text-sm leading-relaxed">
                par nos experts pour confirmer la proposition du Conseiller
                Solaire. Elle se déroule à distance ou sur place
              </p>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center text-center px-2">
              ...
              <h3 className="text-xl font-bold text-edf-orange mb-3 leading-tight">
