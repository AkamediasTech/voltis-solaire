  ...
  const testimonials = [
    {
      ...
      image: "https://images.unsplash.com/photo-1544168190-79c11e66b380?q=80&w=800&auto=format&fit=crop", 
      quote: "« Les économies sur les factures vont de 58 % à 96 % au mois d'août »",
      author: "Normandie - Famille Damotte"
    },
    {
      // Image proche : Homme debout à l'extérieur (balcon/terrasse)
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=800&auto=format&fit=crop", 
      quote: "« Depuis les 4 derniers mois où il fait bien soleil dans la région, la consommation d'électricité représente, grâce aux panneaux solaires, 90 % d'économies sur ma facture. »",
      author: "Auvergne-Rhône-Alpes - Famille Gonnet"
    },
    {
      // Image proche : Portrait homme sénior extérieur
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=800&auto=format&fit=crop", 
      quote: "« Les deux installations me font économiser plus de 60 % sur ma facture. »",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((item, index) => (
            <div key={index} className="relative h-[500px] rounded-sm overflow-hidden group shadow-lg cursor-pointer">
              <img 
                src={item.image} 
