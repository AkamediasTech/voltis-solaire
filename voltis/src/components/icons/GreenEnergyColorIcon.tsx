...
interface GreenEnergyColorIconProps {
  className?: string;
}

const GreenEnergyColorIcon: React.FC<GreenEnergyColorIconProps> = ({
  className = "w-9 h-9",
}) => {
  return (
    <svg
...
export default GreenEnergyColorIcon;
